...
const SettingPage = function () {
  ...
  const currentPasswordBlurHandler = (e) => {
    if (e.target.value.length >= 8 && e.target.value.length <= 20)
      setCurrentPasswordValid(true);
    else setCurrentPasswordValid(false);
  };
  ...
  return (
    <div>
      <Alert open={alertEnabled} handle={setAlertEnabled}>
        <p>Updated Changes</p>
      </Alert>
        ...
        <div className="px-2">
          ...
          <div className="">
            ...
            <p className="italic text-red-700">
              {usernameValid
                ? ""
                : "Should be between 4 and 50 characters and not includes spaces"}
            </p>
          </div>
        </div>
        <div className="px-2">
        ...
        <div className="px-2 py-4">
          ...
          <div className="">
            ...
            <p className="italic text-red-700">
              {passwordValid
                ? ""
                : "Should be between 8 and 20 characters and not include spaces"}
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex pt-2 pl-2">
              <input
                className={`border-2 rounded-md w-full p-2 outline-none text-lg ${
                  !currentPasswordValid ? "border-red-500" : "border-gray-400"
                }
                }`}
                ...
                onChange={(event) => {
                  ...
                  currentPasswordBlurHandler(event);
                }}
              ></input>
            </div>

            <p className="italic px-2 pt-1 text-red-700 text-sm">
      ...
      <div className="flex justify-center">
        <button
          className="border-2 rounded-md px-3 py-1.5 text-lg outline-none"
          disabled={
